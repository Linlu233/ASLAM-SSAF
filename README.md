...
![EPIC-Fuse Framework](./model_architecture.png)
...
```bibtex
@misc{epic_fuse_2026,
  title={EPIC-Fuse: Edge-Centric Pair Interaction and Controlled Fusion for Symmetry-Aware Attribute–Structure Link Prediction},
